...
const routes = [{
  ...
  {
    path: '/categoryMajor/:major/:gender',
    name: 'CategoryMajor',
    // route level code-splitting
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: () => import( /* webpackChunkName: "about" */ '../views/CategoryMajor.vue')
  },
  {
    path: '/ranking',
    name: 'Ranking',
  ...
  {
    path: '/Morebooklist/:booklists',
    name: 'Morebooklist',
    // route level code-splitting
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: () => import( /* webpackChunkName: "about" */ '../components/Morebooklist.vue')
